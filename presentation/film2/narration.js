...
const NARRATION = [
  ...
  { scene: 0, at: 9100, text: "One that can actually do things on your machine has a second way to fail. It can not do the thing, and then tell you that it did." },
  ...
  { scene: 2, at: 6000, text: "That was already known about. A note fired the moment she wrote the file, naming the broken link." },
  ...
  { scene: 5, at: 9900, text: "So the fix was not a better note. It was a refusal. The exchange is not allowed to end while something it was told about is still broken." },
