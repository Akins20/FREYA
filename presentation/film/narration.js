...
const NARRATION = [
  ...
  { scene: 0, at: 8600, text: "One sentence, typed the way you'd type it yourself, and after that nobody touches the keyboard." },
  ...
  { scene: 6, at: 12200, text: "It's two hundred and forty pounds more than we signed off, which you would otherwise have found on Thursday, halfway through the call." },
  ...
  { scene: 7, at: 13300, text: "It could just as easily have been a spreadsheet, or a PDF, if that's what the job needed." },
  ...
  { scene: 10, at: 14400, text: "Eleven minutes, start to finish, and you weren't at the desk for any of it." },
  ...
  { scene: 12, at: 13700, text: "All fifteen came back with an answer, and not one of them got stuck or gave up halfway." },
  ...
  { scene: 13, at: 10000, text: "And we didn't take her word for that. We asked the programs, and each of them wrote down what she had done to it." },
  ...
  { scene: 16, at: 8300, text: "It's one program, on your own machine, written and run on a laptop from twenty fourteen." },
